 ...
 */
public class StoreTransactionInputSplit extends InputSplit implements Writable {


	public StoreTransactionInputSplit() {  }

	public int records; public STATE state;

	public StoreTransactionInputSplit(int records, STATE state) {
